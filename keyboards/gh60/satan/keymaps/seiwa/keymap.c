...
#define _CTQWVIM    2   // Controls
#define _CTQWEMACS  3   // Controls
#define _DB        4   // Debugging
#define _ZZ        5   // Layer switch
...
[_ZZ] = LAYOUT_60_ansi(
  TG(_ZZ) , SWDF0  , SWDF1  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , SWLYCLR, \
